...
export default {
  common: {
    ...
    completed: '완료',
    verification: '인증',
    pleaseCompleteVerification: '계속하려면 인증을 완료하세요',
    shieldTips: '본 사이트는 Turnstile로 보호됩니다. 차단 프로그램을 사용 중이라면 Cloudflare 위젯을 허용하세요.',
    verificationFailed: '인증 실패, 다시 시도하세요',
    turnstileSiteKeyMissing: 'Turnstile sitekey가 설정되지 않았습니다',
    turnstileInitFailed: 'Turnstile 초기화에 실패했습니다',
    turnstileExpired: '인증이 만료되었습니다. 다시 인증하세요',
    turnstileError: 'Turnstile 오류가 발생했습니다. 다시 시도하세요'
  },
  auth: {
  ...
  shop: {
    ...
    stats: {
      global_nodes: '글로벌 노드',
      global_nodes_desc: 'Amazon 기반 전 세계에 분포된 고속 노드',
      speed: '고속 경험',
