...
export default {
  common: {
    ...
    pleaseCompleteVerification: 'Пожалуйста, завершите проверку для продолжения',
    shieldTips: 'Сайт защищен Turnstile. Если вы используете блокировщики, разрешите виджеты Cloudflare.',
    verificationFailed: 'Проверка не удалась, попробуйте снова',
    turnstileSiteKeyMissing: 'Не настроен Turnstile sitekey',
    turnstileInitFailed: 'Не удалось инициализировать Turnstile',
    turnstileExpired: 'Срок действия проверки истек, выполните проверку снова',
    turnstileError: 'Ошибка Turnstile, попробуйте снова'
  },
  auth: {
  ...
  shop: {
    ...
    stats: {
      ...
      global_nodes_desc: 'Высокоскоростные узлы по всему миру при поддержке Amazon',
