...
export default {
  common: {
    ...
    completed: 'تکمیل شد',
    verification: 'تأیید',
    pleaseCompleteVerification: 'برای ادامه لطفاً تأیید را کامل کنید',
    shieldTips: 'این سایت با Turnstile محافظت می‌شود. اگر از مسدودکننده استفاده می‌کنید، ویجت‌های Cloudflare را مجاز کنید.',
    verificationFailed: 'تأیید انجام نشد، لطفاً دوباره تلاش کنید',
    turnstileSiteKeyMissing: 'Turnstile sitekey پیکربندی نشده است',
    turnstileInitFailed: 'راه‌اندازی Turnstile ناموفق بود',
    turnstileExpired: 'تأیید منقضی شده است، لطفاً دوباره تأیید کنید',
    turnstileError: 'خطای Turnstile، لطفاً دوباره تلاش کنید'
  },
  auth: {
  ...
  shop: {
    ...
    stats: {
      ...
      global_nodes_desc: 'نودهای پرسرعت در سراسر جهان با پشتیبانی Amazon',
      speed: 'تجربه سریع',
