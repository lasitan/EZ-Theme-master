...
export default {
    common: {
        ...
        welcome: `欢迎光临 ${SITE_CONFIG.siteName}`,
        login: '登录',
        register: '注册',
        logout: '退出登录',
        email: '邮箱',
        ...
        completed: '已完成',
        verification: '验证',
        pleaseCompleteVerification: '请完成验证以继续',
        shieldTips: '本站已启用 Turnstile 保护，如使用拦截器请允许 Cloudflare 小组件。',
        verificationFailed: '验证失败，请重试',
        turnstileSiteKeyMissing: '未配置 Turnstile siteKey',
        turnstileInitFailed: 'Turnstile 初始化失败',
        turnstileExpired: '验证已过期，请重新验证',
        turnstileError: 'Turnstile 出错，请重试'
    },
    ...
    dashboard: {
        welcome: '欢迎回窝',
        welcomeDesc: '瞄一眼云游战况',
        siteAnnouncement: '站内吆喝',
        subscriptionInfo: '套餐档案',
        planName: '套餐花名',
        expiryDate: '到期日子',
        planTraffic: '套餐流量仓',
        remainingTraffic: '流量小金库',
        remainingDays: '还能几天',
        accountBalance: '钱包存款',
        permanent: '永久',
        none: '无',
        days: '天',
        noPlanPrompt: '还没上车，先挑一份心仪套餐吧',
        importSubscription: '导入魔法',
        purchasePlan: '上车买票',
        resetTraffic: '清仓洗流',
        activateDataCycleInAdvance: '抢跑下一轮流量',
    ...
    more: {
        title: '更多花活',
        description: '这里都是顺手好用的小玩意',
        viewHelp: '摸鱼翻文档',
        viewNodes: '巡礼节点表',
        manageOrders: '回顾剁手史',
        getTechnicalSupport: '工单问天去',
        manageProfile: '打理个人卡'
    },
    nodes: {
        title: '节点列表',
    ...
    shop: {
        ...
        no_plans_found: '这页空空如也',
        try_different_filter: '换个口味再筛',
        reset_filter: '一键清空筛',
        plan: {
            purchase: '马上上车',
            sold_out_btn: '已售罄',
        ...
        stats: {
            global_nodes: '全球节点',
            global_nodes_desc: '依赖Amazon实现遍布全球的高速节点',
            speed: '极速体验',
