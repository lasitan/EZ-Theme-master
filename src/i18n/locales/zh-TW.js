...
export default {
  common: {
    ...
    completed: '已完成',
    verification: '驗證',
    pleaseCompleteVerification: '請完成驗證以繼續',
    shieldTips: '本站已啟用 Turnstile 保護，如使用封鎖器請允許 Cloudflare 小元件。',
    verificationFailed: '驗證失敗，請重試',
    turnstileSiteKeyMissing: '未配置 Turnstile siteKey',
    turnstileInitFailed: 'Turnstile 初始化失敗',
    turnstileExpired: '驗證已過期，請重新驗證',
    turnstileError: 'Turnstile 發生錯誤，請重試'
  },
  auth: {
    loginTitle: '歡迎回來',
  ...
  shop: {
    ...
    stats: {
      global_nodes: '全球節點',
      global_nodes_desc: '依賴 Amazon 實現遍佈全球的高速節點',
      speed: '極速體驗',
