...
export default {
  common: {
    ...
    completed: '完了',
    verification: '認証',
    pleaseCompleteVerification: '続行するには認証を完了してください',
    shieldTips: '本サイトは Turnstile により保護されています。ブロッカー使用時は Cloudflare ウィジェットを許可してください。',
    verificationFailed: '認証に失敗しました。もう一度お試しください',
    turnstileSiteKeyMissing: 'Turnstile sitekey が設定されていません',
    turnstileInitFailed: 'Turnstile の初期化に失敗しました',
    turnstileExpired: '認証の有効期限が切れました。再度認証してください',
    turnstileError: 'Turnstile エラーが発生しました。もう一度お試しください'
  },
  auth: {
    loginTitle: 'おかえりなさい',
  ...
  shop: {
    ...
    stats: {
      ...
      global_nodes_desc: 'Amazon によって支えられた世界中の高速ノード',
      speed: '高速体験',
