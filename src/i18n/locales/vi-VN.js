...
export default {
    common: {
        ...
        pleaseCompleteVerification: 'Vui lòng hoàn tất xác minh để tiếp tục',
        shieldTips: 'Trang này được bảo vệ bởi Turnstile. Nếu bạn dùng trình chặn, hãy cho phép widget Cloudflare.',
        verificationFailed: 'Xác minh thất bại, vui lòng thử lại',
        turnstileSiteKeyMissing: 'Chưa cấu hình Turnstile sitekey',
        turnstileInitFailed: 'Khởi tạo Turnstile thất bại',
        turnstileExpired: 'Xác minh đã hết hạn, vui lòng xác minh lại',
        turnstileError: 'Lỗi Turnstile, vui lòng thử lại'
    },
    auth: {
    ...
    shop: {
        ...
        stats: {
            ...
            global_nodes_desc: 'Node tốc độ cao trên toàn cầu được Amazon hỗ trợ',
