...
export default {
    common: {
        ...
        pleaseCompleteVerification: 'Please complete verification to continue',
        shieldTips: 'This site is protected by Turnstile. If you use blockers, please allow Cloudflare widgets.',
        verificationFailed: 'Verification failed, please retry',
        turnstileSiteKeyMissing: 'Turnstile sitekey is not configured',
        turnstileInitFailed: 'Turnstile initialization failed',
        turnstileExpired: 'Verification expired, please verify again',
        turnstileError: 'Turnstile error, please try again'
    },
    auth: {
    ...
    shop: {
        ...
        stats: {
            ...
            global_nodes_desc: 'High-speed nodes worldwide powered by Amazon',
            speed: 'Blazing Fast',
