...
// removed: apiAvailabilityChecker (no API endpoint probing)
...
const DEFAULT_SHIELD_CONFIG = {
    ...
    // 禁用CF预先许可，完全依赖面板自发令牌
    preclearTrustCookies: false
};

export const SHIELD_CONFIG = mergeDeep(DEFAULT_SHIELD_CONFIG, getConfig('SHIELD_CONFIG'));
