      ...
      <div class="auth-split-right">
        ...
        <div class="auth-form-container" v-else>
          ...
          <form class="auth-form" @submit.prevent="handleLogin">
            ...
            <button 
              type="button" 
              class="btn btn-secondary btn-block google-login-btn" 
              :disabled="loading" 
              @click="handleGoogleLogin"
            >
              <svg width="18" height="18" viewBox="0 0 262 262" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" style="flex-shrink: 0;">
